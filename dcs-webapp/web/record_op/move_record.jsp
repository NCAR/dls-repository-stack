...
<html:html>
<head>
	<title><st:pageTitle title="Move Record" /></title>
	...
	<script>
		...
		function doExit () {
			window.location = '${contextPath}/record_op/single.do?command=move&recId=${rof.recId}&exit=true'
			}
...
<st:pageHeader toolLabel="Move Record" />

<st:breadcrumbs>
	${rof.recId}
	<st:breadcrumbArrow />
	<span class="current">Move</span>
</st:breadcrumbs>
...
<c:if test="${not empty rof.docReader}">
	...
	<html:form action="/record_op/single" method="GET">
		...
		<table>
			<tr valign="bottom">
				<td align="center">
					<div class="input-label">Select move destination</div>

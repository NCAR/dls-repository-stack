...
<link rel='stylesheet' type='text/css' href='${contextPath}/auth/auth-styles.css'>

</head>

<body>
<st:authPageHeader toolLabel="${title}" logoPath="${contextPath}/images/${applicationScope.logo}"/>

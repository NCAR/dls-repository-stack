...
<c:set var="title">${asnForm.xmlFormat} - Manage Framework Standards</c:set>
...
<script type="text/javascript" src="manage_standards.js"></script>
...
<p>Select the standards documents that will be available to catalogers for each Framework.
</p>
<p>NOTE: To Disable standards display for a particular collection, 
...
<table cellpadding="0px" cellspacing="0px" width="100%">
	<tr valign="middle">
		<td>
			<h1 style="display:inline">${adnForm.xmlFormat}</h1> framework
		</td>
...
<div style="padding:0px 0px 5px 0px;border-bottom:thin solid #333366">Selected Standards Documents for each configured Metadata Framework, grouped by
subject.</div>
		...
		<c:choose>
			...
			<table class="framework-header-table">
				<td style="white-space:nowrap">
					<div class="collapsible-button" id="${xmlFormat}_framework">
...
<%-- 				<td width="95%" align="center" style="white-space:nowrap">
			...
			<%-- FRAMEWORK CONTENT --%>
			<div id="${xmlFormat}_framework_content" class="framework_content" style="display:none">
...
<%-- 											<span class="command-button edit-button" style="float:right"><a href='#' 
								...
								<c:forEach var="docInfo" items="${subjectItems}" >
									...
									<c:set var="classNames">std-doc-item ${registered_doc ? 'registered-doc' : ''} ${extra_doc ? 'extra-doc' : ''}</c:set>
									<tr class="${classNames}">

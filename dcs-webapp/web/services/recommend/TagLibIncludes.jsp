...
test="${param.rt == 'validate'}"><resp:setContentType>text/html</resp:setContentType></c:when><c:otherwise><resp:setContentType>text/xml</resp:setContentType>
</c:otherwise></c:choose><c:set var="contextPath"><%@ include file="/ContextPath.jsp" %></c:set>

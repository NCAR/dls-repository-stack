...
<!--PURPOSE-->
<!-- **************************************-->
<!--To transform nsdl_dc version 1.03 metadata records to the ncs_item version 1.02 format.-->
...
<!--Last modified: 2007-10-23 by Katy Ginger-->
<!--License information:
...
<!-- ********************************************************-->
	...
	<record xmlns="http://ns.nsdl.org/ncs" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ns.nsdl.org/ncs http://ns.nsdl.org/ncs/ncs_item/1.02/schemas/ncs-item.xsd">
...
<!--begin educationLevels-->
	...
	<!--match to <dct:educationLevel xsi:type="nsdl_dc:NSDLEdLevel">-->
						...
						<xsl:with-param name="url">http://ns.nsdl.org/schemas/ed_type/ed_type_v1.00.xsd</xsl:with-param>
						<xsl:with-param name="altTag">otherEdLevel</xsl:with-param>
					</xsl:apply-templates>
					<xsl:apply-templates select="dct:educationLevel[not(@xsi:type='nsdl_dc:NSDLEdLevel')]" mode="toncs">
			...
			<xsl:if test="string-length($content) > 0">
				<xsl:element name="interactivityLevel" namespace="http://ns.nsdl.org/ncs">
					<xsl:apply-templates select="ieee:interactivityLevel">
						...
						<xsl:with-param name="url">http://www.dlese.org/Metadata/nsdl_ncs/1.02/vocabs/interactivityLevelLOM.xsd</xsl:with-param>
			...
			<xsl:if test="string-length($content) > 0">
				<xsl:element name="interactivityType" namespace="http://ns.nsdl.org/ncs">
					<xsl:apply-templates select="ieee:interactivityType">
						<xsl:with-param name="tag">LOM</xsl:with-param>
						<xsl:with-param name="url">http://www.dlese.org/Metadata/nsdl_ncs/1.02/vocabs/interactivityTypeLOM.xsd</xsl:with-param>
						<xsl:with-param name="altTag">description</xsl:with-param>
					</xsl:apply-templates>
				</xsl:element>
			</xsl:if>	

...
<html>
<head>	
	<title>ListCollections example 1</title> 
</head>
<body>
...
<p>
<h2>ListCollections example 1</h2>
...
<table border="1" cellpadding="2" cellspacing="0" style="background-color:#eeeeee" width="95%"> 
	<tr>
		<td colspan="2">
			This example displays information about the collections that are in the library 
			[<a href="ListCollections-example1.txt">view JSP code</a>]
		</td>
	</tr>
	<tr>
...
<table cellpadding="6" cellspacing="0" border="1" width="95%">
	<tr>
		<th>
			<nobr>Collection name label<br>
			displayed to users</nobr>
		</th>
		<th>
			<nobr>Number of<br>records</nobr>
		</th>
		<th>
			<nobr>Number of<br>records indexed</nobr>
		</th>
		<th>
			<nobr>Collection's<br>vocab entry</nobr>
		</th>
		<th>
			<nobr>Search<br>key</nobr>
		</th>
		<th>
			<nobr>Enabled<br>for discovery</nobr>
		</th>
		<th>
			<nobr>Display<br>to users?</nobr>
		</th>		
		<th>
			<nobr>Collection's<br>record ID</nobr>
		</th>				
	</tr>
	...
	<x:forEach select="$xmlDom/DDSWebService/ListCollections/collections/collection">
		<tr>
			<td>
				<%-- We are already at XPath $xmlDom/DDSWebService/ListCollections/collections/collection
				so we can continue our path from there --%>				
				<x:out select="renderingGuidelines/label"/>
			</td>
			<td>
				<x:out select="additionalMetadata/numRecords"/>
			</td>
			<td>
				<x:out select="additionalMetadata/numRecordsIndexed"/>
			</td>
			<td>
			...
			<td>
				<x:out select="additionalMetadata/isEnabled"/>
			</td>
			<td>

  ...
  <xsl:template match="/el:taglib">
    <html>
      ...
      <body>
		...
		<p>
			To use the EL functions, include the application Java library in the web applicatation classpath.
			Then reference the functions library in JSP pages using the following directive:
			<div style="padding:8px">
				<nobr><code>&lt;%@ taglib prefix=&quot;elfuncs&quot; uri=&quot;http://www.dlsciences.org/elfuncs&quot; %&gt;</code></nobr>
			</div>
		</p>
		<p>
			See the 
		...
		<p>Return to <a href="overview-summary.html">Javadoc</a>.</p>
		<br/>
				...
				<p>
					<b>Function is mapped to:</b>
						<div class="specs">
							...
							<div class="specs">
									<xsl:choose>
										<xsl:when test="starts-with(el:function-class,'org.dpc')">
											<xsl:element name="a">

 ...
 *  edu.ucar.dls.dds.action.DDSAdminQueryAction} Struts Action class.
 *
...
public final class DDSAdminQueryForm extends VocabForm implements Serializable {
	...
	/**
	 *  Gets all formats that exist natively in the index. Each xml format String has a leading '0' character at the beginning.

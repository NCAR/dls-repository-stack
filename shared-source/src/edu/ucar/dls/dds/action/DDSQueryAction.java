...
public final class DDSQueryAction extends Action {
	...
	public static DDSStandardSearchResult ddsStandardQuery(
		...
		if (index != null) {
			...
			resultDocs = index.searchDocs(booleanQuery, whatsNewFilter, sort, docReaderAttributes, null);
	 ...
	 *  using {@link edu.ucar.dls.index.SimpleLuceneIndex}.encodeToTerm() is replaced with the encoded form for

...
import edu.ucar.dls.webapps.tools.OutputTools;
...
public class SetInfo implements Serializable, Comparable {
	...
	private ArrayList<DirInfo> dirInfos = new ArrayList();
    ...
    /**
     *  Constructor for a SetInfo object created from an existing (legacy) DirInfo object.
     *
     * @param  name         The human-readable name of the set
     * @param  setSpec      The oai setSpec that will be used to reference this set
     * @param  description  A description for this set, in XML form.
     * @param  enabled      [true | false]
     * @param  id           Id
     * @param existingDirInfos The existing DirInfo, the first of which is the default dir and format
     * @param existingAttributes  The existing attributes to populate
     */
    public SetInfo(String name,
                   String setSpec,
                   String description,
                   String enabled,
                   String id,
                   ArrayList<DirInfo> existingDirInfos,
                   HashMap existingAttributes) {
        this.name = name.trim();
        this.setSpec = setSpec.trim();
        this.description = description.trim();
        this.enabled = enabled.trim().toLowerCase();
	 ...
	 */
	public ArrayList<DirInfo> getDirInfos() {
		return dirInfos;
	}

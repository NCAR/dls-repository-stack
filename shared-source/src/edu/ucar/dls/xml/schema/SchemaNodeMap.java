...
/**
 *  Map structure holding {@link edu.ucar.dls.xml.schema.SchemaNode} instances,
...
public class SchemaNodeMap {
	...
	public boolean init() {
		...
		4/18 - we were using TreeMap, and the lar framework could not be processed.
		So I'm, switching back to HashMap and hope the note above is correct!

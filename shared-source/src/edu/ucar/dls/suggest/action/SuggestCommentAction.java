...
package edu.ucar.dls.suggest.action;

import edu.ucar.dls.suggest.SuggestUtils;
import edu.ucar.dls.suggest.comment.*;
import edu.ucar.dls.suggest.resource.urlcheck.*;
import edu.ucar.dls.suggest.action.form.SuggestCommentForm;
...
public final class SuggestCommentAction extends SuggestAction {
	...
	private static void prtln(String s) {
		if (debug) {
			edu.ucar.dls.schemedit.SchemEditUtils.prtln(s, "SuggestCommentAction");
		}
	}

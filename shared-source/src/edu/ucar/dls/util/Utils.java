...
// The ValueSortedMap is implemented in DLSLibs, using the Apache Commons Collections packages
...
public class Utils {
     ...
     * @throws ParseException If unable to interpret the date String using the given format specifier.
     */
     ...
     * @throws ParseException If unable to interpret the date Date using the given format specifier.
     */
    ...
    /**
     * Get a String showing the elapsed time that occurred between two points of time as recorded in java Date objects.
     *
    ...
    public static String getElapsedTimeString(Date start, Date end) {
        ...
        return (min + " minutes and " + sec + "." + ms + " seconds");
    }


    /**
     * Get the elapsed time in milliseconds that occurred between two points of time as recorded in java Date objects.
     *
     * @param start The start Date.
     * @param end   The end Date.
     */
    public static long getElapsedTimeMilliSec(Date start, Date end) {
     ...
     * @throws UnsupportedEncodingException If unable to encode using UTF-8.
     */
     ...
     * @throws ArrayIndexOutOfBoundsException If the specified field is out of range (field < 0 || field >=
     *                                        7)
     */

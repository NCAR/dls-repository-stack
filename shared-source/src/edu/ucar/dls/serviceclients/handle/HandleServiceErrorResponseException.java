...
/**
 *  Indicates a standard error response was recieved from a Handle service request.
 *
 * @author    Ostwald
 */
public final class HandleServiceErrorResponseException extends Exception {
	String code = null;
	String msg = null;
	 ...
	 */
	public HandleServiceErrorResponseException(String code, String msg, String serviceRequest) {
		super("The handle " + serviceRequest + " request returned an error response (code " + code + "): " + msg);
		this.code = code;
		this.msg = msg;

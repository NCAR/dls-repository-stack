...
package edu.ucar.dls.serviceclients.remotesearch;
...
public class SearchServiceClient {
	 ...
	 *  edu.ucar.dls.serviceclients.remotesearch.WebServiceClient}) and returns
	 *  results as a List of {@link edu.ucar.dls.serviceclients.remotesearch.reader.ADNItemDocReader}
	 *  instances.
	 *

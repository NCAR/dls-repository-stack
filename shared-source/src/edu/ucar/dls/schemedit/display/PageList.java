...
/**
 *  Manages information about the metadata editor UI pages to support the presentation of frameworks
 as "chunked" by the top-level elements in the schema.<p>
 *  PageList is created {@link edu.ucar.dls.schemedit.config.FrameworkConfigReader},

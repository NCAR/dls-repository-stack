...
public class AbstractConfigReader implements Serializable {
	...
	public AbstractConfigReader(URL url) throws Exception {
		this(TimedURLConnection.importURL (url.toString(), "utf-8", 5000));
	}
	...
	*/
	...
	/**
	 *  Reinitializes without saving state first. Writes Document to disk and then set docMap to null, forcing a re-read upon next access.
	 */
	public void refresh() {
		this.docMap = null;
		prtln (" ... refreshed");

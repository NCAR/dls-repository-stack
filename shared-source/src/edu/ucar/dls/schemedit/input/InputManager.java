...
public class InputManager {
	 ...
	 *  edu.ucar.dls.schemedit.input.InputField} object or an {@link
	 *  edu.ucar.dls.schemedit.input.AnyTypeInputField} object as appropriate.
	 *
	 *@param  paramName     NOT YET DOCUMENTED
	 ...
	 *
	 *  The work is done by {@link edu.ucar.dls.xml.schema.SchemaHelper#checkValidValue(String,String)},
	...
	public static void setPreserveWhiteSpace (boolean bool) {
		preserveWhiteSpace = bool;
	}
	
	/**
	* By default, whitespace within element and attribute values is ignored (i.e., stripped).
	Setting preserveWhiteSpace to true will retain whitespace.
	*/
	public static boolean getPreserveWhiteSpace () {

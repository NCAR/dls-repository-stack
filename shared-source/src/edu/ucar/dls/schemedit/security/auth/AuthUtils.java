...
import edu.ucar.dls.schemedit.security.auth.nsdl.NSDLLdapClient;
import edu.ucar.dls.ldap.LdapException;
import edu.ucar.dls.ldap.LdapEntry;
...
public class AuthUtils {
	...
	public static String getPasswordFile() {
		AppConfigurationEntry entry =
			getConfiguredLoginModule("edu.ucar.dls.schemedit.security.login.FileLogin");
		if (entry == null)
			return null;
		String path = null;
		try {

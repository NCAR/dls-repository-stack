...
import edu.ucar.dls.schemedit.security.auth.Auth;
...
public class AuthorizationFilter implements Filter {
	...
	/**
	 *  Sets {@link edu.ucar.dls.schemedit.SessionRegistry} attribute from servletContext. NOTE: SessionRegistry is
...
/* 		String username = "guest";
		String passwd = "guest";
		Auth fa = new edu.ucar.dls.schemedit.security.auth.FileAuth(username, passwd);
		if (fa.authenticate()) {

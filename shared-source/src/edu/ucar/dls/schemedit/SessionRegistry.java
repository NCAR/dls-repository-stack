 ...
 *  edu.ucar.dls.schemedit.SessionBean}s are created when the session is created, and destroyed when the
...
public class SessionRegistry implements ServletContextListener, HttpSessionListener {
	...
	/**
	 *  Unregister a sessionBean by calling its {@link edu.ucar.dls.schemedit.SessionBean#destroy() destroy}
	 ...
	 *
	 * @return    list of {@link edu.ucar.dls.schemedit.SessionBean}
	 */

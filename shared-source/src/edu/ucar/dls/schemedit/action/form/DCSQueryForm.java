...
import edu.ucar.dls.schemedit.action.*;
...
import edu.ucar.dls.index.document.*;

/**
 *  A Struts Form bean for handling query requests that access a {@link
 *  edu.ucar.dls.index.SimpleLuceneIndex}. This class works in conjuction with
 *  the {@link edu.ucar.dls.schemedit.action.DCSQueryAction} Struts Action
 *  class.
 *
...
public final class DCSQueryForm extends ActionForm implements Serializable {
	...
	*/
	 ...
	 *  edu.ucar.dls.index.SimpleLuceneIndex} after sorting them. <p>
	 *

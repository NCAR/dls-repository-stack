...
public final class DCSAdminForm extends RepositoryForm implements Serializable {
	...
	private VirtualPageConfig virtualPageConfig = null;
	...
	public VirtualPageConfig getVirtualPageConfig () {
		return this.virtualPageConfig;
	}
	
	public void setVirtualPageConfig (VirtualPageConfig vpc) {
		this.virtualPageConfig = vpc;
	}

...
import edu.ucar.dls.schemedit.autoform.AutoForm;
 ...
 *
 *@author     ostwald
 <p>$Id: FrameworkConfigAction.java,v 1.8 2011/11/16 23:05:50 ostwald Exp $
 */
	...
	*/
	protected void putRecord(ActionMapping mapping,
		...
		if (this.readOnlyMode)
			throw new Exception ("Repository is Read Only");

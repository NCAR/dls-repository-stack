...
/**
 *  Provides access to, and caching of {@link edu.ucar.dls.schemedit.dcs.DcsDataRecord}
...
public class DcsDataManager {
	 ...
	 */
	public DcsDataRecord getDcsDataRecord(String id, RepositoryManager rm) throws Exception {
	 ...
	 *  indexing, {@link edu.ucar.dls.schemedit.dcs.DcsDataFileIndexingPlugin}
	 ...
	 * @return             The dcsDataRecord value
	 */
	public DcsDataRecord getDcsDataRecord(String collection, String xmlFormat, String fileName) throws Exception {
	 ...
	 * @return             The dcsDataRecord value
	 */
	public DcsDataRecord getDcsDataRecord(String collection, String xmlFormat, String fileName, String id) throws Exception {

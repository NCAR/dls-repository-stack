...
public class NCSCollectReader {
	...
	*/
	...
	public String getOaiFormat() {
		return (getNodeText("/record/collection/ingest/oai/@libraryFormat"));
	}
	...
	public String getSetSpec() {
		return getNodeText("/record/collection/setSpec");
	}
	...
	public static void main(String[] args) throws Exception {
		...
		if (readFromFile) {
			String path = "C:/Documents and Settings/ostwald/devel/dcs-instance-data/local-ndr/records/ncs_collect/1256687231238/NCS-COL-000-000-000-003.xml";
...
/* 			File dir = new File("C:/Documents and Settings/ostwald/devel/dcs-instance-data/local-ndr/records/ncs_collect/1256687231238");
			...
			reader = edu.ucar.dls.schemedit.ndr.util.integration.NSDLCollectionUtils.getNCSRecord(ncsRecId);
			if (reader == null)
		...
		prtln ("setSpec: " + reader.getSetSpec());

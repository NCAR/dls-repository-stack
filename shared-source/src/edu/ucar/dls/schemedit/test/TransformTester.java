...
public class TransformTester {
	...
	String xsl_dir = "L:/ostwald/transform-sandbox/xsl";
	...
	public TransformTester () {
		...
		String defaultClass = "javax.xml.transform.TransformerFactory";
		try {
	...
	public void datacite_test () {
		// String src = "C:/tmp/transform/NSDL_DC_v1.02.xml";
		String src = "L:/ostwald/transform-sandbox/records/osm/osm_for_datacite.xml";
		String transform = "osm-v1.1-to-datacite-vKernel2.2-v2.xsl";
		String transformed = transformFile(src, transform);
		prtln ("\ntransformed:\n" + transformed);
	}	
	...
	public static void main (String[] args) throws Exception {
		...
		showTransformerFactoryClass();
		
		// tester.datacite_test();

...
public class DleseEditorRenderer extends EditorRenderer {
	 ...
	 *    a superclass, such as {@link edu.ucar.dls.schemedit.autoform.SimpleJspRenderer#getMultiBoxInput()}
	 *    </li>
	 *  </ul>
	 *
	 *
	...
	private boolean showXsdStringInput(String xpath) {
		...
		} else if (xmlFormat.equals("lar") && normalizedXPath.equals("/record/standards/standard/id")) {
			return true;
		}
		else {
			return false;

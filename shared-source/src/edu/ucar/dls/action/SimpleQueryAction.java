...
*/
package edu.ucar.dls.action;

import edu.ucar.dls.repository.*;
import edu.ucar.dls.index.*;
import edu.ucar.dls.action.form.*;
...
/**
 *  A Struts Action for handling query requests that access a {@link edu.ucar.dls.index.SimpleLuceneIndex}.
 *  This class works in conjunction with the {@link edu.ucar.dls.action.form.SimpleQueryForm} Struts form
 *  bean class.<p>
 *
 ...
 *  {@link edu.ucar.dls.index.SimpleLuceneIndex} under the key "index." This index will be used to perform
...
public final class SimpleQueryAction extends Action {
	 ...
	 *  that will create it. A {@link edu.ucar.dls.index.SimpleLuceneIndex} must be available to this class via

 ...
 * @see        edu.ucar.dls.index.reader.DleseAnnoDocReader
 */
public class DleseAnnoFileIndexingServiceWriter extends XMLFileIndexingWriter {
	 ...
	 *
	 * @return    The String "edu.ucar.dls.index.reader.DleseAnnoDocReader"
	 */
	public String getReaderClass() {
		return "edu.ucar.dls.index.reader.DleseAnnoDocReader";
	}

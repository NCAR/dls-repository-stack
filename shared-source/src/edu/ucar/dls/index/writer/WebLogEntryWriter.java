 ...
 *  edu.ucar.dls.logging.ClfLogger} and {@link edu.ucar.dls.dds.action.DDSQueryAction}
...
public class WebLogEntryWriter implements DocWriter {
	...
	/**
	 *  Gets the name of the concrete {@link edu.ucar.dls.index.reader.DocReader} class that
	...
	/**
	 *  Create a log entry DocumentWrapper, storing and indexing the given notes.
	 *
	 * @param  logEntry  A single logEntry line
	 * @return           A DocumentWrapper for indexing the request.
	 */
	public final DocumentWrapper createLogEntryDocWrapper(String logEntry) {

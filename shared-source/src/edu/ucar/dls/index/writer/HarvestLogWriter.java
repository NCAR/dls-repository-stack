 ...
 * @see        edu.ucar.dls.index.reader.HarvestLogReader
 */
public class HarvestLogWriter implements DocWriter {
	...
	public String getReaderClass() {
		return "edu.ucar.dls.index.reader.HarvestLogReader";
	}
	 ...
	 */
	public final DocumentWrapper logEntry(
	                               long harvestUid,
	                               long startTime,
	                               long endTime,
	                               int recordCount,
		...
		return addRequiredFields(documentWrapper, adminDefaultBuffer);
	}


	private DocumentWrapper addRequiredFields(DocumentWrapper documentWrapper, StringBuffer adminDefaultBuffer) {
		Document doc = documentWrapper.getDocument();

 ...
 *  edu.ucar.dls.index.reader.NewsOppsDocReader}. <p>
 *
 *
 *
...
public class NewsOppsFileIndexingWriter extends XMLFileIndexingWriter {
	 ...
	 *
	 * @return    The String "edu.ucar.dls.index.reader.NewsOppsDocReader".
	 */
	public String getReaderClass() {
		return "edu.ucar.dls.index.reader.NewsOppsDocReader";
	}

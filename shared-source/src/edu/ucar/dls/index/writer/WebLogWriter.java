 ...
 * @see       edu.ucar.dls.index.reader.WebLogReader
 */
public class WebLogWriter implements DocWriter {
	...
	/**
	 *  Gets the name of the concrete {@link edu.ucar.dls.index.reader.DocReader}
	...
	public String getReaderClass() {
		return "edu.ucar.dls.index.reader.WebLogReader";
	}
	 ...
	 */
	public final DocumentWrapper log(HttpServletRequest request) {
	 ...
	 */
	public final DocumentWrapper log(HttpServletRequest request, String notes) {

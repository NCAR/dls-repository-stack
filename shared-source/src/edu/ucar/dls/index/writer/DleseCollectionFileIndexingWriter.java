 ...
 *  edu.ucar.dls.index.reader.DleseCollectionDocReader}. <p>
 *
 *
 *
...
public class DleseCollectionFileIndexingWriter extends XMLFileIndexingWriter {
	 ...
	 *  edu.ucar.dls.repository.RepositoryManager.putRecord} when the collection was created inside an
	 ...
	 *
	 * @return    The String "edu.ucar.dls.index.reader.DleseCollectionDocReader".
	 */
	public String getReaderClass() {
		return "edu.ucar.dls.index.reader.DleseCollectionDocReader";
	}

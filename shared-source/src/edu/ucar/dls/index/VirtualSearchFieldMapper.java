...
import edu.ucar.dls.index.queryParser.XMLQueryParser;
 ...
 *  parsed by the {@link edu.ucar.dls.index.queryParser.XMLQueryParser} class. See <a
 ...
 *  pairs, and a {@link edu.ucar.dls.index.queryParser.FieldExpansionQueryParser} may be used to apply the
 *  field/term mappings when supplied in regular Lucene query strings.
 *
 * @author     John Weatherley
 * @see        edu.ucar.dls.index.queryParser.FieldExpansionQueryParser
 * @see        edu.ucar.dls.index.queryParser.XMLQueryParser
 */

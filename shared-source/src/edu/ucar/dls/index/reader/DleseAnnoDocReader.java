 ...
 *  edu.ucar.dls.index.writer.DleseAnnoFileIndexingServiceWriter}.
 *
 * @author     John Weatherley
 * @see        edu.ucar.dls.index.ResultDoc
 * @see        edu.ucar.dls.index.writer.DleseAnnoFileIndexingServiceWriter
 */
public class DleseAnnoDocReader extends XMLDocReader {
	 ...
	 *  edu.ucar.dls.index.writer.FileIndexingServiceWriter}.
	 *

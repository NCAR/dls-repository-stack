 ...
 * @version    $Id: JSHTMLAction_1_1.java,v 1.16 2012/05/22 23:04:15 jweather Exp $
 * @see        edu.ucar.dls.services.dds.action.form.JSHTMLForm_1_1
 */
public final class JSHTMLAction_1_1 extends Action {
	...
	protected ActionForward doSearch(
		...
		if (index != null && !isEmptySearch) {
			...
			resultDocs = index.searchDocs(pQuery, dateFilter, sort, docReaderAttributes, null);

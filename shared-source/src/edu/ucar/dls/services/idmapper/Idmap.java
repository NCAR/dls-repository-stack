...
import edu.ucar.dls.services.mmd.CatchDup;
...
public class Idmap {
	 ...
	 *      java edu.ucar.dls.services.idmapper.Idmap
	...
	private void badparms(String msg) {
		...
		prtln("    java edu.ucar.dls.services.idmapper.Idmap");
	 ...
	 *      edu.ucar.dls.services.mmd.MmdRec MmdRec}.
